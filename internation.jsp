...
<head>
    <meta charset="UTF-8">
    <title>FlyHigh.Co- Flight Search</title>
    <style>
        /* Header & Navigation */
        body {
...
<div style="background-color: #fff4e5; padding: 15px 40px; font-size: 16px; color: #333; text-align: center; border-bottom: 1px solid #ffc107;">
    <strong>Important:</strong> Passengers are advised to arrive at the airport at least 
    <strong>3 hours</strong> before international departures and 
    <strong>2 hours</strong> before domestic departures. Carry valid ID and ensure your 
    travel documents are updated. For the latest travel restrictions and health protocols.
</div>

<!-- Search Section -->
<div class="search-wrapper">
    <form class="search-bar" action="FlightSearchServlet" method="post">
...
<div class="flight-list-container">
    ...
    <div class="result-row">
        <div class="flight-no"><a href="#"> <%= flight.get("flight_no") %> </a></div>
