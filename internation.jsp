...
<div class="flight-list-container">
    ...
    <div class="result-row">
        ...
        <div><%= flight.get("departure_time") %> → <%= flight.get("arrival_time") %></div>
        <div><%= flight.get("duration") %></div>
        <div>
            <%= flight.get("stops") %>
            <% if (!"Non-stop".equalsIgnoreCase(flight.get("stops"))) { %>
                (<%= flight.get("stop_location") %>)
            <% } %>
        </div>
        <div><%= flight.get("source") %> → <%= flight.get("destination") %></div>
        <div>₹<%= flight.get("fare") %></div>
        <div class="book-btn">
