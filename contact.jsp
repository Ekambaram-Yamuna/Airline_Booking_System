...
<div class="contact-section">
    <div class="info-boxes">
        ...
        <div class="info-card">
            <div class="icon">✉</div>
            <h3>EMAIL</h3>
            <p><a href="mailto:hello@theme.com">ganga@gmail.com</a></p>
        </div>
    </div>
    ...
    <div class="contact-content">
        <div class="contact-left">
            <h2>Contact info</h2>
            <p>Please contact our customer support team for any inquiries regarding your booking, baggage, or in-flight services.
             Our representatives are available 24/7 to assist you with travel-related concerns, policy clarifications, and more. 
             Stay informed by visiting our official support center.
            </p>
           ...
           <p style="font-weight: bold;font-size: 30px">Feel Free To Contact Us</p>
