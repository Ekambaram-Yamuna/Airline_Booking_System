...
<head>
    <meta charset="UTF-8">
    <title>FlyHigh.co - Travel Booking</title>
    <style >
    body {
...
<div class="container">
    ...
    <p> FlyHigh is a technology company focused on empowering Indian travellers to plan, book and manage their trips across  air. We assist travellers in making smarter travel decisions by leveraging artificial intelligence, machine learning, and data science led innovations on our OTA platforms, comprising our websites and mobile applications. Our vision is to become the most customer-centric travel company, by offering the best customer experience to our users.</p>
    
    <p>Our OTA platforms allow travellers to book flight tickets, while providing travel utility tools and services. Let us help you plan your next vacation with our <a href="#">trip planner</a>.</p>

    <h2>Here's how we can help you:</h2>
    <table class="service-table">
        <tr>
            <td><strong>Flights</strong></td>
            <td>Book domestic as well as international flights on FlyHigh.Co. Check <a href="#">Flight Status</a> for domestic or international flights.</td>
        </tr>
        
    </table>

    <h2>Flight Booking on FlyHigh.Co</h2>
    <p>FlyHigh.Co  flights app and website simplify flight booking. Travellers can finalise their bookings in just a matter of a few clicks. It's both simple and fast. Get free cancellation on your flight tickets. Also, we have multiple <a href="index.jsp">flight booking offers</a> to help you save money.</p>

    <h2>Domestic Flights on FlyHigh.Co</h2>
    <p>We offer Cancellation protection on domestic flights. Get the cheapest domestic airfare with help of fare drop alerts. Our technology helps travellers book <a href="domestic.jsp">cheap flights</a>, on arrival or departure.</p>
    ...
    <h2>Flight Status Tracking on FlyHigh.Co</h2>
    ...
    <p><strong>FlyHigh.Co-Specific Flight Status:</strong></p>
    ...
    <p>Our helpful filters will assist in finding a suitable international destination for your next vacation. Get personalised recommendations on <a href="internation.jsp">international flight ticket</a> booking and hotels.</p>
