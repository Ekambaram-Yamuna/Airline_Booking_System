...
@WebServlet("/domasticFlightSearchServlet")
public class domasticFlightSearchServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String query = "SELECT flight_no, departure_time, arrival_time, duration, stops, source, destination, fare FROM flights WHERE source=? AND destination=?";
            ...
            // 👉 Forwarding to searchFlights.jsp with results
